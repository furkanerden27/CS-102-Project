...
public class OptionsScreen implements Screen {
    ...
    public void show() {
        ...
        sliderStyle.background = createColorDrawable(new Color(0.25f, 0.15f, 0.08f, 1f), 18);
        sliderStyle.knobBefore = createColorDrawable(new Color(0.85f, 0.65f, 0.1f,  1f), 18);
        sliderStyle.knob       = createCircleDrawable((int)(18f * 1.4f), new Color(1f, 0.8f, 0.2f, 1f));
